            ...
            public void onResponse(@NonNull Call<ViewCartModel> call, @NonNull Response<ViewCartModel> response) {
                ...
                if (response.body() == null) {
                    ...
                    for (int i = 0; i < response.body().getCart().size(); i++) {
                        ...
                        price.setText("Rs. " + cart.getPrice());
                    ...
                    totalCharge.setText("Rs. " + response.body().getTotal());
                    ...
                    vatCount.setText("Rs. " + response.body().getVat());
                    ...
                    GrandTotal.setText("Rs. " + response.body().getGrandTotal());
